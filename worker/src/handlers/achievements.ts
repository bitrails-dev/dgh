...
const FIELDS = ['year', 'title', 'title_ar', 'description', 'description_ar', 'icon'] as const;
...
export async function getAchievement(_req: Request, env: Env, params: Record<string, string>): Promise<Response> {
...
export async function deleteAchievement(_req: Request, env: Env, params: Record<string, string>): Promise<Response> {
